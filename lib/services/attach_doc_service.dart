...
class AttachDocService {
  ...
  Future attachDoc(
      {required BuildContext context, required int docId, required int empId, required String userName, required String attachments}) async {
    try {
      ...
      if (response.statusCode == 200) {
        CustomSnackBar.showSnackBar(context: context, message:"Document Upload Successfully");
